            ...
            <div class="d-flex align-items-center justify-content-center w-100">
                <div class="row justify-content-center w-100">
                    <div class="col-md-8 col-lg-6 col-xxl-3">
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="{{ url('admin-dashboard') }}" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                ...
                                <form>
                                    ...
                                    <a href="{{ url('/admin-forgot-password') }}" class="btn btn-primary w-100 py-8 fs-4 mb-4 rounded-2">Forgot Password</a>
                                </form>
                            </div>
                        </div>
                    </div>
