    ...
    <main>
        ...
        <section class="shop-checkout container">
            ...
            <div class="checkout-steps">
                <a href="{{ url('/shop-cart') }}" class="checkout-steps__item active">
                ...
                <a href="{{ url('/shop-checkout') }}" class="checkout-steps__item">
                ...
                <a href="{{ url('/shop-order-complete') }}" class="checkout-steps__item">
            ...
            <div class="shopping-cart">
                <div class="cart-table__wrapper">
                    <table class="cart-table">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <div class="shopping-cart__product-item">
                                        <img loading="lazy" src="{{ asset('user/assets/images/cart-item-1.jpg') }}"
                            ...
                            <tr>
                                <td>
                                    <div class="shopping-cart__product-item">
                                        <img loading="lazy" src="{{ asset('user/assets/images/cart-item-2.jpg') }}"
                                            width="120" height="120" alt="" />
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="shopping-cart__product-item">
                                        <img loading="lazy" src="{{ asset('user/assets/images/cart-item-3.jpg') }}"
                                            width="120" height="120" alt="" />
                                    </div>
                                </td>
                                <td>
                    ...
                    <div class="cart-table-footer">
                        <form action="{{ url('/shop-checkout') }}" class="position-relative bg-body">
