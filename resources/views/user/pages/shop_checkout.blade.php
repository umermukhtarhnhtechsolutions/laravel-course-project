    ...
    <main>
        ...
        <section class="shop-checkout container">
            ...
            <div class="checkout-steps">
                ...
                <a href="{{ url('shop-checkout') }}" class="checkout-steps__item active">
            ...
            <form name="checkout-form" action="{{ url('/shop-order-complete') }}">
                                    ...
                                    <div class="form-label-fixed hover-container">
                                        ...
                                        <div class="js-hover__open">
                                            <input type="text"
                                                ...
                                                id="search-dropdown" name="search-keyword" readonly href="#"
                            ...
                            <div class="checkout__payment-methods">
                                ...
                                <div class="policy-text">
                                    ...
                                    throughout this website, and for other purposes described in our <a
                                        href="{{ url('/terms') }}" target="_blank">privacy policy</a>.
                                </div>
                            </div>
