                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto" src="{{ asset('user/assets/images/products/product_0.jpg') }}"
                                            width="674" height="674" alt="" />
                                        <a data-fancybox="gallery" href="{{ asset('user/assets/images/products/product_0.jpg') }}"
                                    ...
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto" src="{{ asset('user/assets/images/products/product_0-1.jpg') }}"
                                            width="674" height="674" alt="" />
                                        <a data-fancybox="gallery" href="{{ asset('user/assets/images/products/product_0-1.jpg') }}"
                                            data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <use href="#icon_zoom" />
                                    ...
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto" src="{{ asset('user/assets/images/products/product_0-2.jpg') }}"
                                            width="674" height="674" alt="" />
                                        <a data-fancybox="gallery" href="{{ asset('user/assets/images/products/product_0-2.jpg') }}"
                                            data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <use href="#icon_zoom" />
                                    ...
                                    <div class="swiper-slide product-single__image-item">
                                        <img loading="lazy" class="h-auto" src="{{ asset('user/assets/images/products/product_0-3.jpg') }}"
                                            width="674" height="674" alt="" />
                                        <a data-fancybox="gallery" href="{{ asset('user/assets/images/products/product_0-3.jpg') }}"
                                            data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                            <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                xmlns="http://www.w3.org/2000/svg">
                                                <use href="#icon_zoom" />
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy" class="h-auto"
                                            src="{{ asset('user/assets/images/products/product_0.jpg') }}" width="104" height="104"
                                            alt="" /></div>
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                            class="h-auto" src="{{ asset('user/assets/images/products/product_0-1.jpg') }}" width="104"
                                            height="104" alt="" /></div>
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                            class="h-auto" src="{{ asset('user/assets/images/products/product_0-2.jpg') }}" width="104"
                                            height="104" alt="" /></div>
                                    <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                            class="h-auto" src="{{ asset('user/assets/images/products/product_0-3.jpg') }}" width="104"
                                            height="104" alt="" /></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="product-single__reviews-list">
                            <div class="product-single__reviews-item">
                                <div class="customer-avatar">
                                    <img loading="lazy" src="{{ asset('user/assets/images/avatar.jpg') }}" alt="" />
                                </div>
