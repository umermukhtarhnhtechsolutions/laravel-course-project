        ...
        <div class="row row-cols-lg-5 row-cols-2">
            ...
            <div class="footer-column footer-menu mb-4 mb-lg-0">
                ...
                <ul class="sub-menu__list list-unstyled">
                    <li class="sub-menu__item"><a href="{{ url('/about') }}" class="menu-link menu-link_us-s">About
                            Us</a></li>
                    <li class="sub-menu__item"><a href="{{ url('/contact') }}" class="menu-link menu-link_us-s">Contact
                            Us</a></li>
                </ul>
            </div><!-- /.footer-column -->
            ...
            <div class="footer-column footer-newsletter col-12 mb-4 mb-lg-0">
                ...
                <div class="mt-4 pt-3">
                    ...
                    <p class="mt-2">
                        <img loading="lazy" src="{{ asset('user/assets/images/payment-options.png') }}"
